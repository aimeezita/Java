...
//completamente erradas. Por quê?
		...
		System.out.println("Fim da primeira parte do exercício 5");
		long longContador =1;
		long longFatorial=1;
		
		for(longContador = 1; longContador <= 20; longContador++) {
			longFatorial = longFatorial * longContador;
			System.out.println(longFatorial);
		}
		//Por que a variável int não consegue armazenar números tão grandes.
...
//0, 1, 1, 2, 3, 5, 8, 13, 21, etc... Para calculá-la, o primeiro elemento vale 0, o segundo vale 1, daí por diante,
